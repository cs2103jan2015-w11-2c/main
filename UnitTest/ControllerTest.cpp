...
public:
	...
	*/
	...
	Controller controller;
	DateTime today;
	int expTargetMin = today.getCurrentMinute() + 10; 
	int expTargetHr = today.getCurrentHour();
	int expTargetDay = today.getCurrentDay();
	int expTargetMon = today.getCurrentMonth(); 
	int expTargetYr = today.getCurrentYear();
	...
	controller.calculateTargetDateTime(targetMin, targetHr, targetDay, targetMon, targetYr);
	Assert::AreEqual(expTargetMin, targetMin);
	Assert::AreEqual(expTargetHr, targetHr);
	//Assert::AreEqual(expTargetDay, targetDay);
